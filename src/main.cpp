...
void test_odbc()
{
	string const CONNSTR_MSACCESS = 
		...
		"DBQ=..\\data.mdb;"\
		"UID=Admin;PWD=;";
	string const CONNSTR_LOCAL = 
		"DRIVER={SQL Server};SERVER=(local);"\
		"DATABASE=大庆炼化工程造价系统数据库;"\
		"UID=sa;PWD=123";
	string const CONNSTR_SGAQCOMPUTER = 
		"DRIVER={SQL Server Native Client 10.0};"\
	     	"SERVER=sgaqcomputer;"\
		"DATABASE=大庆炼化工程造价系统数据库;UID=sa;PWD=123";
	string const CONNSTR_DEQING = 
		"DRIVER={SQL Server};"\
		"SERVER=60.190.173.110,1433;"\
		"DATABASE=神机妙算公共资源数据库;"\
		"UID=神机妙算招投标;PWD=2009-10-12 17:20:36";
	string const ORACLE_TYZ = 
		"DRIVER={Oracle in OraDb10g_home1};"\
	   	"SERVER=10.126.10.33/DQLHGCZJ;"\
		"DBQ=10.126.10.33/DQLHGCZJ;"\
		"UID=dqlhgczj;PWD=1234POIU";
	...
	string const SQL4 = "update [01项目信息] set [地区代码] = '大庆炼化i'";
...
void test_mssql_native_client_10_sqlgetdata()
{
